  ...
  const handleChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    switch (inputName) {
      ...
      case "unit3":
        ...
        break;
      case "unit4":
        baseValue = inputValue.times(new Big("745.7"));
        break;
      case "unit5":
        baseValue = inputValue.times(new Big("0.293071"));
        break;
      case "unit6":
        baseValue = inputValue.times(new Big("17.5843"));
        break;
      case "unit7":
